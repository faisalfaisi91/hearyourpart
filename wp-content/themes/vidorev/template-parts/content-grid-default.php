<article id="post-<?php the_ID(); ?>" <?php post_class('post-item site__col'); ?>>
	<div class="post-item-wrap">
		...
		do_action('vidorev_thumbnail', apply_filters('vidorev_custom_grid_default_archive_image_size', 'vidorev_thumb_16x9_1x'), apply_filters('vidorev_custom_grid_default_archive_image_ratio', 'class-16x9'), 1, NULL, $image_ratio_case);
		?>
