...
<article id="post-<?php the_ID(); ?>" <?php post_class('post-item site__col'); ?>>
	...
	<div class="post-item-wrap">
		...
		<?php do_action('vidorev_thumbnail', apply_filters('vidorev_custom_list_blog_archive_image_size', $image_size, $sidebarControl), apply_filters('vidorev_custom_list_blog_archive_image_ratio', 'class-16x9'), 1, NULL, apply_filters('vidorev_custom_list_blog_archive_image_ratio_case', $image_ratio_case, $sidebarControl));?>
		...
		<div class="listing-content">
			...
			<a href="<?php echo esc_url(vidorev_get_post_url()); ?>" class="bloglisting-read-more h7"><?php esc_html_e('Continue reading', 'vidorev')?></a>		
		</div>
