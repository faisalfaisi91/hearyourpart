...
class YZ_Group_Mods_Widget extends WP_Widget {

	function __construct() {
		parent::__construct(
			'yz_group_moderators_widget',
			__( 'Youzer - Group Moderators', 'youzer' ),
			array( 'description' => __( 'Group moderators widget', 'youzer' ) )
		);
	}
	...
	public function form( $instance ) {
		...
		<!-- Mods Number. -->
		<p>
			<label for="<?php echo $this->get_field_id( 'limit' ); ?>"><?php _e( 'Moderators Number:', 'youzer' ); ?>
