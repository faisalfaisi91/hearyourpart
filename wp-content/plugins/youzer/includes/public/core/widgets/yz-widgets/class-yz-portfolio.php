    ...
    function widget() {
		...
		<li>
            <figure class="yz-project-item">
                <div class="yz-projet-img"><img loading="lazy" <?php echo yz_get_image_attributes( $photo_path ); ?> alt=""></div>
				<figcaption class="yz-pf-buttons">
                        ...
                        <a class="yz-lightbox-img" href="<?php echo $photo_path; ?>" data-lightbox="yz-portfolio" <?php if ( ! empty( $photo['title'] ) ) { echo "data-title='" . esc_attr( $photo['title'] ) . "'"; } ?>></a>
				</figcaption>
			</figure>
		</li>
