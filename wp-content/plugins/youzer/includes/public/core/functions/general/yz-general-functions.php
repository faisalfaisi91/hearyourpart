...
function yz_get_group_cover( $group_id = null ) {
    ...
    return "<img class='yz-cover' loading='lazy' src='$cover_path' alt=''>";
}
 ...
 * Get Image
 */
function yz_get_image_attributes( $img_url ) {
    return apply_filters( 'yz_get_image_attributes', "src='$img_url'", $img_url );
}