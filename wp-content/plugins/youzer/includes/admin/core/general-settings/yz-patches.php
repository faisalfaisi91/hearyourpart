...
function yz_patch_optimize_database() {
    ...
    // Get Global Request
	// $options = $wpdb->get_results( "SELECT option_name FROM " . $wpdb->prefix . "options WHERE autoload = 'yes' AND option_name Like 'yz_%'", ARRAY_A );
	// $options = wp_list_pluck( $options, 'option_name' );
