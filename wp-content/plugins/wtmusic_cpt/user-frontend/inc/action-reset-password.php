...
function uf_reset_password_messages( $message ) {
	switch ( $message ) {
		case 'invalid_key':
			?><div class="symple-box red"><p><?php _e( 'Invalid Key.', 'user-frontend-td' ); ?></p></div><?php
			break;
		case 'password_reset_mismatch':
			?><div class="symple-box red"><p><?php _e( 'The passwords do not match.', 'user-frontend-td' ); ?></p></div><?php
			break;
		default:
			break;
	}
