...
function uf_forgot_password_messages( $message ) {
	switch ( $message ) {
		case 'confirmationsend':
			?><div class="symple-box green"><p><?php _e( 'Check your e-mail for the confirmation link.', 'user-frontend-td' ); ?></p></div><?php
			break;
		case 'empty_username':
			?><div class="symple-box red"><p><?php _e( 'Please enter something.', 'user-frontend-td' ); ?></p></div><?php
			break;
		case 'invalid_email':
			?><div class="symple-box red"><p><?php _e( 'The E-Mail address is not valid.', 'user-frontend-td' ); ?></p></div><?php
			break;
		case 'invalidcombo':
			?><div class="symple-box red"><p><?php _e( 'Your input doesn\'t match anything.', 'user-frontend-td' ); ?></p></div><?php
			break;
		case 'no_password_reset':
			?><div class="symple-box red"><p><?php _e( 'This action is not allowed.', 'user-frontend-td' ); ?></p></div><?php
			break;
		default:
			break;
	}
