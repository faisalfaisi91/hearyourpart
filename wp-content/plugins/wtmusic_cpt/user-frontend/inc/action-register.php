...
function uf_register_messages( $message ) {
	...
	switch ( $message ) {
		...
		case 'illegal_names':
			?><div class="symple-box red"><p><?php _e( 'Invalid Username.', 'user-frontend-td' ); ?></p></div><?php
			break;
		case 'username_exists':
			?><div class="symple-box red"><p><?php _e( 'This username exists.', 'user-frontend-td' ); ?></p></div><?php
			break;
		case 'empty_email':
		case 'user_email':
		case 'invalid_email':
			?><div class="symple-box red"><p><?php _e( 'Invalid E-Mail address.', 'user-frontend-td' ); ?></p></div><?php
			break;
		case 'email_exists':
		case 'user_email_used':
			?><div class="symple-box red"><p><?php _e( 'E-Mail exists.', 'user-frontend-td' ); ?></p></div><?php
			break;
		case 'registerfail':
			?><div class="symple-box red"><p><?php _e( 'Something went wrong. Please consult the administrator.', 'user-frontend-td' ); ?></p></div><?php
			break;
		default:
			break;
	}
