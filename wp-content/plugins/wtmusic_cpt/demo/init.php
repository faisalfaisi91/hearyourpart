...
if ( !class_exists( 'Radium_Theme_Demo_Data_Importer' ) ) {
	...
	class Radium_Theme_Demo_Data_Importer extends Radium_Theme_Importer {
		 ...
		 * @var string
		 */
		public $theme_options_framework = 'optiontree'; // radium
		 ...
		 * @var string
		 */
		public $theme_option_name       = 'option_tree'; //set theme options name here (key used to save theme options). Optiontree option name will be set automatically
		...
		public $pages_demo_file_name  = 'pages.xml';

		public $slider_file_name  = '';
