<?php
/*Template Name: Archive Playlist*/
get_header(); 
			...
			<div class="site__row sidebar-direction">							
				<main id="main-content" class="site__col main-content">	
					...
					<div class="blog-wrapper global-blog-wrapper blog-wrapper-control">
						<?php
						$template_playlist_query = array(
							'post_type' 			=> 'vid_playlist',
							'posts_per_page' 		=> vidorev_get_option('vid_playlist_items_per_page', 'vid_playlist_layout_settings', 10),
							'post_status' 			=> 'publish',
						...
						if(isset($_GET['archive_query']) && trim($_GET['archive_query'])!=''){
							switch(trim($_GET['archive_query'])){
								case 'comment':					
									$template_playlist_query['orderby']		= 'comment_count date';
									$template_playlist_query['order']		= 'DESC';
									break;
								...
								case 'title':
									$template_playlist_query['orderby']		= 'title';
									$template_playlist_query['order']		= 'ASC';
									break;			
							}
						}
						...
						$playlist_query = new WP_Query($template_playlist_query);
