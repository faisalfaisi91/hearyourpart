<article <?php post_class('post-item site__col'); ?>>
	<div class="post-item-wrap">
		...
		do_action('vidorev_thumbnail', apply_filters('vidorev_custom_grid_small_image_size', 'vidorev_thumb_16x9_0x', $layout), apply_filters('vidorev_custom_grid_small_image_ratio', 'class-16x9', $layout), 1, NULL, $image_ratio_case);
		?>
