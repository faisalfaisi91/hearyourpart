 ...
 * @since 1.0.0
 */
class OPanda_SocialLockerMoreFeaturesMetaBox extends FactoryMetaboxes321_Metabox
{
    /**
    ...
    public $cssClass = 'factory-bootstrap-331 factory-fontawesome-320 opanda-more-features';
    ...
    ?>
        ...
        <ul>
            <li><span><?php _e('More Social Buttons (+5)', 'sociallocker'); ?></span></li>
            <li><span><?php _e('More Beautiful Themes (+3)', 'sociallocker'); ?></span></li>
            <li><span><?php _e('Blurring Effect', 'sociallocker'); ?></span></li>
            <li><span><?php _e('Advanced Options (+8)', 'sociallocker'); ?></span></li>
            <li><span><?php _e('Premium Support', 'sociallocker'); ?></span></li>
        </ul>
        ...
        <?php if ( $alreadyActivated || get_option('onp_sl_skip_trial', false) ) { ?>
            <div class="sl-footer">
                <?php echo sprintf(__('<a href="%s" class="btn btn-primary btn-large">Get Premium for $27<br /><span>(it will take a pair of minutes)</span></a>', 'sociallocker'), onp_licensing_325_get_purchase_url( $sociallocker, 'more-features' ), onp_licensing_325_manager_link($sociallocker->pluginName, 'activateTrial', false)); ?>
            </div>
        <?php } else { ?>
            <div class="sl-footer">
...
FactoryMetaboxes321::register('OPanda_SocialLockerMoreFeaturesMetaBox', $bizpanda);
