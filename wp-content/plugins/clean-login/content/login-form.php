	...
	<form class="cleanlogin-form" method="post" action="<?php echo $login_url;?>">
		...
		<fieldset>
			...
			<div class="cleanlogin-field">
				<input class="cleanlogin-field-username" type="text" name="log" placeholder="<?php echo __( 'Username', 'clean-login' ); ?>" aria-label="Username">
			</div>
			
			<div class="cleanlogin-field">
				<input class="cleanlogin-field-password" type="password" name="pwd" placeholder="<?php echo __( 'Password', 'clean-login' ); ?>" aria-label="Password">
			</div>
