...
?>
<div class="apwpultimate-audio-player-innr-wrap apwp-medium-<?php echo $audiogrid; ?> apwp-columns player-layout-one">					
					<div id="apwpultimate-jplayer-<?php echo $unique; ?>" class="apwpultimate-audio-player-grid jp-jplayer"></div>
					<div id="apwpultimate-jplayer-<?php echo $unique; ?>-cntrl" class="player-main-block  jp-audio" role="application" aria-label="media player">
