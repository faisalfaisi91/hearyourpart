<div class="player-main-block player-layout-grid-one jp-video apwp-audio-player-<?php echo $unique; ?>-css-ance" aria-label="media player">
                                    <div class="jp-type-playlist">
                                        <div class="album-art-block">
                                            <div id="apwp-audio-player-<?php echo $unique; ?>" class="apwp-audio-player jp-jplayer"></div>
                                            ...
                                            <div class="jp-interface">
                                                ...
                                                <div class="jp-controls-holder">
                                                    ...
                                                    <div class="jp-toggles">
                                                       ...
                                                       <?php if(empty($audio_id) && $playlist_hide == false) { ?> <button id="playListBtnOne" class="jp-playlist playlist-btn toggleBlock active" data-id="<?php echo $unique; ?>"></button> <?php } ?>
                                                    </div>
                                                </div>
                                        ...
                                        <div id="playListOne-<?php echo $unique; ?>" class="jp-playlist <?php if(!empty($audio_id)) { echo 'playlist-hide'; } else { echo 'playlist-block';} ?>">
