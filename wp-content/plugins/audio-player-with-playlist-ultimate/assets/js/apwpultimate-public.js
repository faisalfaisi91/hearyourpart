jQuery(document).ready(function ($) {
	...
	$( '.apwp-audio-player-wrp' ).each(function( index ) {
		...
		var player_conf 	= $.parseJSON( $(this).closest('.apwp-audio-player-wrp').find('.apwpultimate-conf').text());
		var playlist 		= {};
		var playlist_obj 	= [];
	...
	$( '.apwpultimate-audio-player-grid' ).each(function( index ) {
		...
		var player_conf 	= $.parseJSON( $(this).closest('.apwpultimate-audio-player-innr-wrap').find('.apwpultimate-conf').text());
